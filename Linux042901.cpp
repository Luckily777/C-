...
[root@luckily day02]# vim 042801.c
[root@luckily day02]# . / a.out
bash : . / a.out : 没有那个文件或目录
[root@luckily day02]# gcc 042801.c
[root@luckily day02]# ls
042801.c  a.out
[root@luckily day02]# . / a.out
fun1()
...
[root@luckily day02]# gcc 042801.c - o test.c
[root@luckily day02]# ls
042801.c  a.out  test.c

[root@luckily day02]# ls - l
总用量 28
- rw - r--r--. 1 root root  249 4月  28 15:38 042801.c
- rwxr - xr - x. 1 root root 8416 4月  28 15 : 40 a.out
- rwxr - xr - x. 1 root root 8416 4月  28 15 : 42 test.c
[root@luckily day02]# gcc - g 042801.c - o test2.c
[root@luckily day02]# ls - l
总用量 40
- rw - r--r--. 1 root root  249 4月  28 15:38 042801.c
- rwxr - xr - x. 1 root root 8416 4月  28 15 : 40 a.out
- rwxr - xr - x. 1 root root 9528 4月  28 15 : 42 test2.c
- rwxr - xr - x. 1 root root 8416 4月  28 15 : 42 test.c
[root@luckily day02]# objdump - dS test.c

test.c：     文件格式 elf64 - x86 - 64
...
00000000004003e0 < _init > :
    ...
    400531 : bf 00 06 40 00       	mov    $0x400600, % edi
    400536 : e8 d5 fe ff ff       	callq  400410 < puts@plt >
    40053b : bf 08 06 40 00       	mov    $0x400608, % edi
    400540:	e8 cb fe ff ff       	callq  400410 < puts@plt >
    400545 : 5d                   	pop % rbp
    400546 : c3                   	retq

    0000000000400547 < fun1 > :
    400547 : 55                   	push % rbp
    400548 : 48 89 e5             	mov % rsp, % rbp
    40054b : bf 11 06 40 00       	mov    $0x400611, % edi
    400550 : e8 bb fe ff ff       	callq  400410 < puts@plt >
    400555 : 5d                   	pop % rbp
    400556 : c3                   	retq

    0000000000400557 < fun2 > :
    400557 : 55                   	push % rbp
    400558 : 48 89 e5             	mov % rsp, % rbp
    40055b : bf 18 06 40 00       	mov    $0x400618, % edi
    400560 : e8 ab fe ff ff       	callq  400410 < puts@plt >
    400565 : 5d                   	pop % rbp
    400566 : c3                   	retq
    ...
    400581 : 4c 8d 25 78 08 20 00 	lea    0x200878(% rip), % r12        # 600e00 < __frame_dummy_init_array_entry >
    400588:	55                   	push % rbp
    400589 : 48 8d 2d 80 08 20 00 	lea    0x200880(% rip), % rbp        # 600e10 < __init_array_end >
    400590:	53                   	push % rbx
    ...
    4005ec:	c3                   	retq
    [root@luckily day02]# onjdump - dS test1.c
    bash : onjdump: 未找到命令...
    [root@luckily day02]# onjdump - dS test2.c
    bash : onjdump: 未找到命令...
    [root@luckily day02]# objdump - dS test2.c

    test2.c：     文件格式 elf64 - x86 - 64
...
0000000000400570 < __libc_csu_init > :
    ...
    4005e8:	48 83 c4 08          	add    $0x8, % rsp
    4005ec:	c3                   	retq
    [root@luckily day02]# rm - rf test2.c
    [root@luckily day02]# rm - rf test.c
    [root@luckily day02]# ls
    042801.c  a.out
